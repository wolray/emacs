...
(global-set-key (kbd "C-M-o") 'my-insert-paragraph)
...
(global-set-key (kbd "C-M-p") 'my-transpose-lines-up)
(define-key key-translation-map (kbd "C-M-[") (kbd "C-l"))
(global-set-key (kbd "C-M-]") 'my-transpose-lines-down)
...
(define-key key-translation-map (kbd "C-M-S-p") (kbd "C-x <left>"))
...
(define-key key-translation-map (kbd "C-x C--") (kbd "C-x C--"))
