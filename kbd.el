...
(global-set-key (kbd "H-h") 'c-highlight-symbol-definition)
...
(global-set-key (kbd "H-y") 'c-highlight-symbol-recall)

;; edmacro
(define-key edmacro-mode-map (kbd "M-g M-i") 'kill-this-buffer)
