...
(let ((map isearch-mode-map))
  ...
  (define-key map (kbd "H-p") 'isearch-query-replace)
...
(let ((map visual-mode-map))
  ...
  (define-key map (kbd "5") 'M-h)
  (define-key map (kbd "6") 'c-indent-paragraph)
  ...
  (define-key map (kbd "n") 'c-marker-set-mark)
...
(global-set-key (kbd "H-\\") 'so-remove-all)
(global-set-key (kbd "H-h") 'c-marker-recall-mark)
(global-set-key (kbd "H-i") 'so-put)
...
(global-set-key (kbd "H-o") 'so-jump-next)
(global-set-key (kbd "H-p") 'c-cua-rectangle-mark-mode)
(global-set-key (kbd "H-s") 'c-cycle-search-whitespace-regexp)
(global-set-key (kbd "H-u") 'so-jump-prev)
(global-set-key (kbd "H-y") 'so-jump-to-def)
...
(with-eval-after-load 'org
  (let ((map org-mode-map))
    ...
    (define-key map (kbd "C-c i") 'org-open-at-point)
