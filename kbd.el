...
(m-map-key 'f-paragraph-backward (kbd "C-2"))
(m-map-key 'f-paragraph-forward (kbd "C-3"))
...
(m-map-key 'f-transpose-paragraphs-down (kbd "M-3"))
(m-map-key 'f-transpose-paragraphs-up (kbd "M-2"))
...
(m-map-key 'kmacro-cycle-ring-next (kbd "M-+"))
(m-map-key 'kmacro-cycle-ring-previous (kbd "M-_"))
(m-map-key 'kmacro-delete-ring-head (kbd "M-S-<backspace>"))
