...
(define-key key-translation-map (kbd "C-M-j") (kbd "M-0"))
(define-key key-translation-map (kbd "C-M-k") (kbd "M-0"))
(define-key key-translation-map (kbd "C-M-l") (kbd "M-0"))
...
(define-key key-translation-map (kbd "M-s") (kbd "M-0"))
