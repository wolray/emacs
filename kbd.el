...
(m-map-key 'f-move-down-line (kbd "M-]"))
(m-map-key 'f-move-down-line-end (kbd "C-M-]"))
(m-map-key 'f-move-down-line-end (kbd "C-c C-9"))
(m-map-key 'f-move-up-line (kbd "C-8"))
(m-map-key 'f-move-up-line (kbd "M-p"))
(m-map-key 'f-move-up-line-beginning (kbd "C-M-p"))
(m-map-key 'f-move-up-line-beginning (kbd "C-c C-8"))
(m-map-key 'f-page-down (kbd "C-M-="))
(m-map-key 'f-page-up (kbd "C-M--"))
...
(m-map-key (kbd "C-x C-q") (kbd "C-M-q"))
(m-map-key (kbd "C-x C-q") (kbd "M-q"))
...
(m-map-key nil (kbd "C-x C-q"))
(m-map-key nil (kbd "C-x C-u"))
(m-map-key nil (kbd "C-x C-v"))
(m-map-key nil (kbd "C-x C-z"))
