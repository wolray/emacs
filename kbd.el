...
(my-map-key 'my-move-beginning-of-line (kbd "C-c C-8"))
(my-map-key 'my-move-down-line (kbd "C-9"))
(my-map-key 'my-move-end-of-line (kbd "C-c C-9"))
(my-map-key 'my-move-up-line (kbd "C-8"))
