...
(my-map-key 'my-cycle-paren-shapes (kbd "C-M-i"))
...
(my-map-key 'my-move-beginning-of-line-origin (kbd "C-c C-8"))
(my-map-key 'my-move-end-of-line (kbd "C-9"))
(my-map-key 'my-page-down (kbd "M-]"))
(my-map-key 'my-page-up (kbd "M-p"))
...
(my-map-key 'my-transpose-paragraphs-down (kbd "C-M-("))
(my-map-key 'my-transpose-paragraphs-down (kbd "M-("))
(my-map-key 'my-transpose-paragraphs-up (kbd "C-M-*"))
...
(my-map-key (kbd "<down>") (kbd "C-M-l"))
(my-map-key (kbd "<down>") (kbd "M-l"))
(my-map-key (kbd "<left>") (kbd "C-j"))
(my-map-key (kbd "<right>") (kbd "C-l"))
(my-map-key (kbd "<up>") (kbd "C-M-j"))
(my-map-key (kbd "<up>") (kbd "M-j"))
...
(my-map-key (kbd "C-x C-e") (kbd "M-y"))
...
(my-map-key nil (kbd "C-M-h"))
(my-map-key nil (kbd "C-M-n"))
