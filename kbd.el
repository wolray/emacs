...
(m-map-key (kbd "M-\"") 'ignore)
(m-map-key (kbd "M-]") 'ignore)
(m-map-key (kbd "M-a") 'ignore)
(m-map-key (kbd "M-b") 'ignore)
(m-map-key (kbd "M-c") 'ignore)
(m-map-key (kbd "M-d") 'ignore)
(m-map-key (kbd "M-e") (kbd "M-:"))
(m-map-key (kbd "M-f") 'ignore)
(m-map-key (kbd "M-g") (kbd "C-g"))
(m-map-key (kbd "M-h") 'ignore)
...
(m-map-key (kbd "M-t") 'ignore)
(m-map-key (kbd "M-u") 'c-word-capitalize)
(m-map-key (kbd "M-v") 'ignore)
(m-map-key (kbd "M-w") 'ignore)
(m-map-key (kbd "M-y") 'ignore)
(m-map-key (kbd "M-z") 'ignore)
(m-map-key (kbd "M-{") 'ignore)
(m-map-key (kbd "M-}") 'ignore)
(m-map-key (kbd "TAB") 'c-tab)
...
(let ((map visual-mode-map))
  ...
  (define-key map (kbd "v") 'symbol-overlay-put)
...
(global-set-key (kbd "H-\\") 'symbol-overlay-mode)
