(define-minor-mode visual-mode
  ...
  (if (not visual-mode) (setq cursor-type 'bar)
    ...
    (define-key visual-mode-map (kbd "3") (key-binding (kbd "C-y")))
...
(m-map-key 'f-kill-region (kbd "C-M-w"))
(m-map-key 'f-kill-region (kbd "C-w"))
(m-map-key 'f-kill-region (kbd "M-w"))
(m-map-key 'f-kill-ring-save (kbd "C-2"))
