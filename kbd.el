...
(m-map-key 'delete-pair (kbd "C-c C-d"))
...
(m-map-key 'f-move-up-line-end (kbd "C-M-p"))
...
(m-map-key 'f-word-capitalize (kbd "M-o"))
(m-map-key 'f-word-downcase (kbd "M-i"))
(m-map-key 'f-word-upcase (kbd "M-u"))
(m-map-key 'kill-this-buffer (kbd "C-x C-k"))
...
(m-map-key (kbd "C-c <left>") (kbd "C-x z"))
...
(m-map-key nil (kbd "C-M-h"))
(m-map-key nil (kbd "C-M-j"))
(m-map-key nil (kbd "C-M-k"))
(m-map-key nil (kbd "C-M-l"))
(m-map-key nil (kbd "C-M-l"))
...
(m-map-key nil (kbd "M-J"))
(m-map-key nil (kbd "M-K"))
(m-map-key nil (kbd "M-L"))
