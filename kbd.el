...
(with-eval-after-load 'symbol-overlay
  (let ((map symbol-overlay-map))
    (define-key map (kbd "4") 'symbol-overlay-toggle-in-scope)
    (define-key map (kbd "t") nil)
    ))
