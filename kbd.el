...
(let ((map (make-sparse-keymap)))
  ...
  (define-key visual-mode-map (kbd "a") map))
...
(global-set-key (kbd "H-\\") 'c-cycle-timestamp-format)
(global-set-key (kbd "H-h") 'c-highlight-symbol-recall)
(global-set-key (kbd "H-i") 'c-highlight-symbol)
(global-set-key (kbd "H-j") 'c-switch-to-next-buffer)
(global-set-key (kbd "H-k") 'kill-this-buffer)
(global-set-key (kbd "H-l") 'c-switch-to-prev-buffer)
(global-set-key (kbd "H-o") 'c-highlight-symbol-next)
(global-set-key (kbd "H-p") 'highlight-symbol-remove-all)
(global-set-key (kbd "H-s") 'c-cycle-search-whitespace-regexp)
(global-set-key (kbd "H-u") 'c-highlight-symbol-prev)
(global-set-key (kbd "H-y") 'c-highlight-symbol-definition)
...
(global-set-key (kbd "C-c 0") 'kill-paragraph)
(global-set-key (kbd "C-c 7") 'backward-kill-paragraph)
(global-set-key (kbd "C-c C-c") 'eval-buffer)
(global-set-key (kbd "C-c \\") 'c-insert-time-stamp)
...
(global-set-key (kbd "C-x .") 'c-open-the-org)
