...
(m-map-key 'f-kill-buffer (kbd "M-1"))
(m-map-key 'f-kill-region (kbd "C-w"))
(m-map-key 'f-kill-ring-save (kbd "M-w"))
(m-map-key 'f-kmacro-call-macro (kbd "C-3"))
...
(m-map-key 'f-toggle-search-whitespace-regexp (kbd "C-1"))
...
(m-map-key 'isearch-forward-regexp (kbd "M-s"))
(m-map-key 'linum-mode (kbd "<f9>"))
(m-map-key 'magit-status (kbd "C-x g"))
(m-map-key 'revert-buffer (kbd "C-x DEL"))
...
(m-map-key (kbd "C-@") (kbd "C-M-f"))
(m-map-key (kbd "C-@") (kbd "C-f"))
(m-map-key (kbd "C-@") (kbd "M-f"))
...
(m-map-key (kbd "C-x C-k C-t") (kbd "C-4"))
...
(m-map-key nil (kbd "C-M-e"))
(m-map-key nil (kbd "C-M-p"))
(m-map-key nil (kbd "C-M-r"))
(m-map-key nil (kbd "C-M-s"))
