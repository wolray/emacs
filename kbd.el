...
(define-key visual-mode-map (kbd "i") 'f-visual-mode-toggle)
(define-key visual-mode-map (kbd "r") 'f-other-window)
...
(m-map-key 'f-cua-rectangle-mark-mode (kbd "C-S-k"))
...
(m-map-key 'f-kmacro-cycle-ring-next (kbd "M-="))
(m-map-key 'f-kmacro-cycle-ring-previous (kbd "M--"))
(m-map-key 'f-kmacro-end-or-call-macro (kbd "C-="))
(m-map-key 'f-kmacro-start-macro (kbd "C--"))
(m-map-key 'f-move-down-line (kbd "C-9"))
(m-map-key 'f-move-down-line-end (kbd "C-3"))
(m-map-key 'f-move-up-line (kbd "C-8"))
(m-map-key 'f-move-up-line-beginning (kbd "C-2"))
(m-map-key 'f-page-down (kbd "M-]"))
(m-map-key 'f-page-up (kbd "M-p"))
(m-map-key 'f-paragraph-backward (kbd "C-7"))
(m-map-key 'f-paragraph-forward (kbd "C-0"))
...
(m-map-key 'f-shell-clear-shell (kbd "C-c c"))
(m-map-key 'f-sort-lines-or-paragraphs (kbd "C-4"))
...
(m-map-key 'f-transpose-paragraphs-down (kbd "M-0"))
(m-map-key 'f-transpose-paragraphs-up (kbd "M-7"))
...
(m-map-key (kbd "C-l") (kbd "C-1"))
(m-map-key (kbd "C-s") (kbd "C-s"))
(m-map-key (kbd "C-u") (kbd "C-`"))
(m-map-key (kbd "C-x 0") (kbd "C-x 4"))
