...
(m-map-key (kbd "C-x C-f") 'c-find-file)
...
(m-map-key (kbd "M-:") 'c-eval-expression)
(m-map-key (kbd "M-;") (kbd ";"))
(m-map-key (kbd "M-<") nil)
(m-map-key (kbd "M->") nil)
(m-map-key (kbd "M-?") nil)
...
(m-map-key (kbd "M-d") 'c-kill-region)
(m-map-key (kbd "M-e") (kbd "C-y"))
(m-map-key (kbd "M-f") 'c-set-or-exchange-mark)
...
(m-map-key (kbd "M-t") 'c-toggle-comment)
...
(m-map-key (kbd "M-z") (kbd "C-/"))
(m-map-key (kbd "M-{") nil)
(m-map-key (kbd "M-}") nil)
(m-map-key (kbd "S-<backspace>") 'c-backward-kill-line)
(m-map-key (kbd "SPC") 'c-toggle-visual-mode)
