...
(global-set-key (kbd "H-h") 'c-marker-recall-mark-0)
...
(global-set-key (kbd "H-y") 'c-marker-recall-mark-1)
...
(let ((map visual-mode-map))
  ...
  (define-key map (kbd "e") 'c-marker-set-mark)
...
(m-map-key (kbd "<f4>") 'read-only-mode)
