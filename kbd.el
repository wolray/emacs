...
(m-map-key (kbd "M-h") 'kmacro-edit-macro)
...
(global-set-key (kbd "C-c n") 'c-kmacro-start-macro)
...
(let ((map edmacro-mode-map))
  (define-key map (kbd "M-g M-h") 'kill-this-buffer)
  )
...
(let ((map visual-mode-map))
  ...
  (define-key map (kbd "n") 'c-kmacro-end-or-call-macro)
  (define-key map (kbd "o") 'C-<right>)
  (define-key map (kbd "p") 'cua-rectangle-mark-mode)
