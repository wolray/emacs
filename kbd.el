...
(define-key number-mode-map (kbd "`") 'self-insert-command)
(define-key number-mode-map (kbd "1") (key-binding (kbd "C-l")))
(define-key number-mode-map (kbd "2") 'c-move-backward-line)
(define-key number-mode-map (kbd "3") 'c-move-forward-line)
(define-key number-mode-map (kbd "4") 'c-toggle-number-mode)
...
(global-set-key (kbd "`") 'c-toggle-number-mode)
...
(m-map-key 'c-eval-expression (kbd "C-;"))
...
(m-map-key 'c-sort-lines-or-paragraphs (kbd "<f6>"))
...
(m-map-key (kbd "C-<backspace>") (kbd "C-k"))
...
(m-map-key (kbd "ESC C-<backspace>") (kbd "K"))
(m-map-key (kbd "M-<") (kbd "C-x 8"))
(m-map-key (kbd "M->") (kbd "C-x 9"))
(m-map-key (kbd "M-^") (kbd "N"))
